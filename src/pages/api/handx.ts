import { ConcealedCondition, DealerCondition, EMPTY_QUESTION_RESPONSE, HandType, Meld, PointType, QuestionResponse, Score, Side, Tile, Wind, isConcealedCondition, isDealerCondition, isTile } from "@/type";
...
export default function handler(req: NextApiRequest, res: NextApiResponse<QuestionResponse>) {
  ...
  const { query, parameters } = createHandFetchQuery(dealerCondition, concealedCondition, doublesLower, doublesUpper)
